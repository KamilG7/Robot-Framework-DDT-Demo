...
${ADDRESS_CHANGED_MESSAGE_LOCATOR} =            xpath=//div[@class='woocommerce-message']
${ADDRESS_CHANGED_MESSAGE} =                    Address changed successfully
${ADDRESS_COUNTRY_LIST_INDEX} =                 xpath=//li[@tabindex='-1']

${SHOP_BUTTON_LOCATOR} =                        xpath=//li[@id='menu-item-21']/a[@class='nav__link']
${SHOP_LOADED_CONFIRMATION_LOCATOR} =           xpath=//header/h1[contains(text(), 'Shop')]
${SHOP_PRODUCT_LOCATOR} =                       xpath=//h2[@class='woocommerce-loop-product__title']
